...
public class MySplineChart extends DemoView {
    ...
    public MySplineChart(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        initView();
    }

    public MySplineChart (Context context, AttributeSet attrs){
        super(context, attrs);
        initView();
    }

    public MySplineChart(Context context, AttributeSet attrs, int defStyle) {
